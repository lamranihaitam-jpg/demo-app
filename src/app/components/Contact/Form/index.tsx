    ...
    <section id='contact'>
      <div className='container'>
        <div className='relative'>
          <h2 className='mb-9 font-bold tracking-tight'>Contactez-nous</h2>
          <form
            ...
            <div className='sm:flex gap-3 w-full'>
              <div className='mx-0 my-2.5 flex-1'>
                ...
                <input
                  ...
                  placeholder='John'
                  className='w-full text-base px-4 rounded-2xl py-2.5 border-solid border transition-all duration-500 hover:border-[#102C46] focus:border-[#102C46] focus:outline-0'
                />
              </div>
              <div className='mx-0 my-2.5 flex-1'>
            ...
            <div className='w-full mx-0 my-2.5 flex-1'>
              ...
              <textarea
                ...
                onChange={handleChange}
                className='w-full mt-2 rounded-2xl px-5 py-3 border-solid border transition-all duration-500 hover:border-[#102C46] focus:border-[#102C46] focus:outline-0'
                ...
                className={`border leading-none px-6 text-lg font-medium py-4 rounded-full 
                    ${
                      !isFormValid || loader
                        ...
                        : 'bg-[#102C46] border-[#102C46] text-white hover:bg-transparent hover:text-[#102C46] cursor-pointer'
                    }`}>
                Envoyer
              </button>
            </div>
