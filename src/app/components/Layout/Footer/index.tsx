...
const Footer = () => {
  ...
  return (
    <div className='bg-footer-dark' id='first-section'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-16 xl:gap-8'>
          <div className='col-span-4 flex flex-col gap-5'>
            ...
            <p className='text-white text-lg font-medium leading-7'>
              {' '}
              Améliorez vos compétences, et décrochez <br /> l’emploi dont vous rêvez.{' '}
            </p>
            <div className='flex gap-4'>
              <Link
                href='/'
                className='bg-white/20 rounded-full p-2 text-white hover:bg-[#C5A972] duration-300'>
                <Icon
