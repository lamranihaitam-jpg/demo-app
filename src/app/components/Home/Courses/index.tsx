            ...
            <div className='flex flex-row space-x-4'>
              <div className='flex'>
                <Image
                  ...
                  alt='circle'
                />
                <p className='text-lightgrey ml-1'>30</p>
              </div>
              <div className='flex'>
                <Image
    ...
    <section id='courses-section'>
      <div className='container mx-auto max-w-7xl px-4'>
        <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-5 mb-4'>
          <h2 className='font-bold tracking-tight'>Nos Formations</h2>
          <div>
        ...
        {/* Trusted companies logos placed right below the courses section */}
        <Companies />
      </div>
    </section>
  )
